      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm bg-white p-8 shadow-xl shadow-gray-200/50 rounded-2xl border border-gray-100">
            ...
            <div className="mt-2">
              <input
                ...
                className={`block w-full rounded-md border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ${
                  errors.name ? "ring-red-500 focus:ring-red-500" : "ring-gray-300 focus:ring-indigo-600"
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                type="url"
                className={`block w-full rounded-md border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ${
                  errors.photoUrl ? "ring-red-500 focus:ring-red-500" : "ring-gray-300 focus:ring-indigo-600"
                } placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 outline-none transition-all`}
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                autoComplete="new-password"
                className={`block w-full rounded-md border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ${
                  errors.confirmPassword ? "ring-red-500 focus:ring-red-500" : "ring-gray-300 focus:ring-indigo-600"
                } placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 outline-none transition-all`}
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            ...
            <button
              type="button"
              className="flex w-full items-center justify-center gap-3 rounded-md bg-gray-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
              onClick={() => alert("GitHub registration clicked!")}
            >
