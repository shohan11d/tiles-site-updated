      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm bg-white p-8 shadow-xl shadow-gray-200/50 rounded-2xl border border-gray-100">
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            ...
            <button
              type="button"
              className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-md bg-gray-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
