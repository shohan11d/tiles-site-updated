        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2">
              <div className="h-6 w-6 rounded-md bg-linear-to-br from-indigo-500 to-pink-500" />
              <span className="text-lg font-bold tracking-tight text-gray-900">
                Tiles<span className="text-indigo-500">Gallery</span>
              </span>
            </Link>
            <p className="text-sm text-gray-500 max-w-xs leading-relaxed">
              Curating the finest tiles for your living spaces. Modern, elegant, and timeless designs for every home.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4">
              <Link href="#" className="h-8 w-8 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 transition-colors hover:bg-indigo-50 hover:text-indigo-500">
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="text-sm text-gray-500 space-y-2">
              <li>123 Tile Street, Design District</li>
              <li>New York, NY 10001</li>
              <li className="pt-2">
                <Link href="/contact" className="text-indigo-500 font-medium hover:underline">
                  Send us a message
                </Link>
              </li>
            </ul>
